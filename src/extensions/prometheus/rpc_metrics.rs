...
impl InnerMetrics {
    fn new(registry: &Registry) -> Self {
        ...
        let finalized_miss_counter =
            CounterVec::new(Opts::new("finalized_miss_counter", "No help"), &["method"]).unwrap();
        let finalized_query_counter =
            CounterVec::new(Opts::new("finalized_query_counter", "No help"), &["method"]).unwrap();
        let call_times =
